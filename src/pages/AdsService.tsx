    ...
    <div className="flex flex-col bg-brand-50">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <ScrollReveal className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-brand-950 tracking-tight leading-[1.1] mb-8">
          ...
          <p className="text-xl text-brand-500 max-w-3xl mx-auto mb-12 leading-relaxed">
